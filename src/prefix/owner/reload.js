...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!category || !command) return message.channel.send('Please provide a category and command name to reload.');
        ...
        try {
            ...
            return message.reply(` Cannot reload \`${command}\` from \`${category}\`\n\`\`\`${error}\`\`\``)
        }
    }
};